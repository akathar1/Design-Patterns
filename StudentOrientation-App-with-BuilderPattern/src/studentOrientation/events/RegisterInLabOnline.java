 ...
 * @author abhi2
 */
public class RegisterInLabOnline implements CourseRegisterationInterface {
     ...
     * @param durationIn
     */
    public RegisterInLabOnline(CurrencyInterface costIn, EffortsInterface effortsIn, CarbonFootPrintInterface footPrintIn, TimeInterface durationIn) {
        discount = 0.00;
        ...
        Logger.writeMessage(" RegisterInLabOnline constructor called...", Logger.DebugLevel.CONSTRUCTOR);

    }

    @Override
    public String toString() {
        return "RegisterInLabOnline{" + "duration=" + duration + ", effort=" + effort + ", cost=" + cost + ", discount=" + discount + ", footPrint=" + footPrint + ", costName=" + costName + ", effortName=" + effortName + ", footPrintName=" + footPrintName + ", timeName=" + timeName + '}';
    }
