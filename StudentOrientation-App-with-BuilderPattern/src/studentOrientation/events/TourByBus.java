 ...
 * @author abhi2
 */
public class TourByBus implements CampusTourInterface {
     ...
     * @param durationIn
     */
    public TourByBus(CurrencyInterface costIn, EffortsInterface effortsIn, CarbonFootPrintInterface footPrintIn, TimeInterface durationIn) {
        ...
        Logger.writeMessage(" TourByBus constructor called...", Logger.DebugLevel.CONSTRUCTOR);
    }
