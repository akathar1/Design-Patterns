 ...
 * @author abhi2
 */
public class RegisterInOffice implements CourseRegisterationInterface {
     ...
     * @param durationIn
     */
    public RegisterInOffice(CurrencyInterface costIn, EffortsInterface effortsIn, CarbonFootPrintInterface footPrintIn, TimeInterface durationIn) {
        discount = 0.03;
        ...
        Logger.writeMessage("RegisterInOffice constructor called...", Logger.DebugLevel.CONSTRUCTOR);

    }

    @Override
    public String toString() {
        return "RegisterInOffice{" + "duration=" + duration + ", effort=" + effort + ", cost=" + cost + ", discount=" + discount + ", footPrint=" + footPrint + ", costName=" + costName + ", effortName=" + effortName + ", footPrintName=" + footPrintName + ", timeName=" + timeName + '}';
    }
