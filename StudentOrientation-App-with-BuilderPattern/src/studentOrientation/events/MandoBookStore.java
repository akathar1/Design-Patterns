 ...
 * @author abhi2
 */
public class MandoBookStore implements BuyingBooksInterface {
     ...
     * @param durationIn
     */
    public MandoBookStore(CurrencyInterface costIn, EffortsInterface effortsIn, CarbonFootPrintInterface footPrintIn, TimeInterface durationIn) {
        discount = 0.00;
        ...
        Logger.writeMessage("MandoBookStore constructor called...", Logger.DebugLevel.CONSTRUCTOR);
    }

    @Override
    public String toString() {
        return "MandoBookStore{" + "duration=" + duration + ", effort=" + effort + ", cost=" + cost + ", discount=" + discount + ", footPrint=" + footPrint + ", costName=" + costName + ", effortName=" + effortName + ", footPrintName=" + footPrintName + ", timeName=" + timeName + '}';
    }
