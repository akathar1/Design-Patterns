 ...
 * @author abhi2
 */
public class DormInLine implements SelectingDormInterface {
     ...
     * @param durationIn
     */
    public DormInLine(CurrencyInterface costIn, EffortsInterface effortsIn, CarbonFootPrintInterface footPrintIn, TimeInterface durationIn) {
        surcharge = 0.00;
        ...
        Logger.writeMessage("DormInLine constructor called...", Logger.DebugLevel.CONSTRUCTOR);
    }

    @Override
    public String toString() {
        return "DormInLine{" + "duration=" + duration + ", effort=" + effort + ", cost=" + cost + ", surcharge=" + surcharge + ", footPrint=" + footPrint + ", costName=" + costName + ", effortName=" + effortName + ", footPrintName=" + footPrintName + ", timeName=" + timeName + '}';
    }
