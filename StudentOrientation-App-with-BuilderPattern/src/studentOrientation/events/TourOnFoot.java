 ...
 * @author abhi2
 */
public class TourOnFoot implements CampusTourInterface {
     ...
     * @param durationIn
     */
    public TourOnFoot(CurrencyInterface costIn, EffortsInterface effortsIn, CarbonFootPrintInterface footPrintIn, TimeInterface durationIn) {
        cost = costIn.getValue();
        ...
        Logger.writeMessage(" TourOnFoot constructor called...", Logger.DebugLevel.CONSTRUCTOR);
    }

    @Override
    public String toString() {
        return "TourOnFoot{" + "duration=" + duration + ", effort=" + effort + ", cost=" + cost + ", footPrint=" + footPrint + ", costName=" + costName + ", effortName=" + effortName + ", footPrintName=" + footPrintName + ", timeName=" + timeName + '}';
    }
