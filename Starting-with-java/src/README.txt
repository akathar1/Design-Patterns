...
To design an application which reads contents of the file with multiple threads and assign courses to them according tomtheir preferences. And also the project intends to develop a well designed appliction.
...
Steps for program compilation :
  1. Unzip the tarball using following command :
	tar -xvf anand_kulkarni_assign2.tar.gz	
  2. Traverse inside the project folder by using following command :
	cd anand_kulkarni_assign2/primeThreads/
  3. Compile all java classes by using following command :	
